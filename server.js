...
【最重要ルール — 必ず守ること】
1. カルテに書く文章はすべて必ず丁寧語にすること。文末は必ず「〜です」「〜ます」「〜でした」「〜ません」「〜とのことです」「〜の様子でした」で終わらせること。

【文体の具体例】
× NG：「自信がなく不安そうだ。」　→　○ OK：「自信がなく不安そうでした。」
× NG：「先延ばしの傾向がある。」　→　○ OK：「先延ばしの傾向が見られます。」
× NG：「判断材料がない。」　→　○ OK：「判断材料がありません。」
× NG：「確認できず。」　→　○ OK：「確認できませんでした。」
× NG：「情報収集が必須。」　→　○ OK：「情報収集が必要です。」
× NG：「〜と思われる。」　→　○ OK：「〜と思われます。」
× NG：「〜している。」　→　○ OK：「〜しているとのことです。」
2. 書き起こしにはチューターと生徒の両方の発言が混在している。チューターが自分自身の体験・経験として語っている内容（「俺は〜だった」「私は受験生時代〜」「先生も昔〜」等）は生徒の情報ではないため、絶対にカルテに記入しないこと。生徒本人の発言・様子・状況のみを記録すること。
